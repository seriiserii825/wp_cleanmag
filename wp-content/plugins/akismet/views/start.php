<div id="akismet-plugin-container">
    ...
    <div class="akismet-box">
		...
		<div class="akismet-boxes">
		  ...
		  <?php if ( $akismet_user && in_array( $akismet_user->status, array(
				  'active',
				  'active-dunning',
				  'no-sub',
				  'missing',
            ...
            <div class="akismet-box">
              ...
              <p><?php echo sprintf( esc_html( __( 'You are connected as %s.', 'akismet' ) ), '<b>' . esc_html( $akismet_user->user_login ) . '</b>' ); ?>
          ...
          <div class="akismet-box">
				  ...
				  'text'    => __( 'Sign up with a different email address', 'akismet' ),
				  'classes' => array( 'akismet-button' ),
			  ) ); ?>
						</div>
          ...
          <div class="akismet-box">
						...
						<div class="akismet-right">
							<?php Akismet::view( 'get', array(
				  'text'    => __( 'Get your API key', 'akismet' ),
        ...
        <div class="akismet-box">
					...
					<p><?php esc_html_e( 'Already have your key? Enter it here.', 'akismet' ); ?>
            <a href="https://docs.akismet.com/getting-started/api-key/" target="_blank"><?php esc_html_e( '(What is an API key?)', 'akismet' ); ?></a></p>
